...
function Q6MenuBar(objName, barName) {
	...
	this.menus = [];
	//<div class="title" name="title"><span class="titleText">' + barName + '</span></div>
}
...
Q6MenuBar.prototype.item2Str = function(menuItem){
	return '<div class="menuItem" onMouseMove="' + this.obj + '.itemMouseMove(this)" onMouseOut="' + this.obj + '.itemMouseOut(this)" onClick="skip(\'' + menuItem.url + '\', \'' + menuItem.frameName + '\')">' + menuItem.menuItemName + '</div>\n';
}
...
Q6MenuBar.prototype.itemMouseMove = function(e) {
	...
	e.style.backgroundColor = "#c7debd";
	e.style.color = "black";
}

Q6MenuBar.prototype.itemMouseOut = function(e) {
	
	e.style.backgroundColor = "#f7f1df";
}

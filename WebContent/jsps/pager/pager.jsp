...
<c:choose>
    ...
    <%-- 共N页 到M页 --%>
    <span style="font-family:KaiTi;font-size:16px;">共${pb.tp }页</span>
    <span style="font-family:KaiTi;font-size:16px;">到</span>
    <input type="text" class="inputPageCode" id="pageCode" value="${pb.pc }"/>
    <span style="font-family:KaiTi;font-size:16px;">页</span>
